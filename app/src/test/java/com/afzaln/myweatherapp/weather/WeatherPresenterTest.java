...
import static com.afzaln.myweatherapp.data.TestUtils.listOf;
import com.afzaln.myweatherapp.data.Weather;
import com.afzaln.myweatherapp.data.Weather.Coord;
...
import com.afzaln.myweatherapp.util.RxUtils;
import com.afzaln.myweatherapp.weather.WeatherContract.View;
...
public class WeatherPresenterTest {
    ...
    public void doStringWeatherSearch()  {
        ...
        verify(weatherView, times(3)).showProgressBar(progressCaptor.capture());
